...
for (int i = 8; i < 15; i++) // back sensors, 8-15
{
    float value = pinArray(i);
...
error = 0;           // reset for new error
 ...
 switch(Array){
   ...
   case [0 1 1 1 0 0 0 0]: 
    error = 3;
    break;
   case [0 1 1 1 1 0 0 0]: 
    error = 2;
    break;
   case [0 0 1 1 1 0 0 0]: 
    error = 1;
    break;
   case [0 0 1 1 1 1 0 0]: // ideal case
    error = 0;
    break;
   ...
   case [0 0 0 0 0 0 0 0]:
    if (_preverror = 7)
      ...
      error = -8;
      break;
   default: // in Default sensor are probably tripping, just let it drive forwards untill next measurement.
    error = 0;
    break;
 }
