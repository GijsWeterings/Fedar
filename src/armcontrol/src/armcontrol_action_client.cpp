...
public:
  ...
  RobotArm()
  {
    ...
    traj_client_ = new TrajClient("/left_arm_controller/joint_trajectory_action", true);

    // wait for action server to come up
    while(!traj_client_->waitForServer(ros::Duration(30.0))){
  ...
  */
  control_msgs::FollowJointTrajectoryGoal armExtensionTrajectory()
  {
    ...
    goal.trajectory.joint_names.push_back("lower_arm_joint");
